...
{ 
    static void Main()
    {
        Console.WriteLine("In what season are you looking to book a stay?");
        string season = Console.ReadLine();

        Console.WriteLine("On a weekend or weeknight?");
        ...
        else if (!(summer || weekend)) //could just be else statement
        {
